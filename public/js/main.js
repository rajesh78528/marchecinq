(function($) {
    ...
    $(document).ready(function() {
        ...
        $(".fashion-blog-slider").on("beforeChange", function(
            event,
            slick,
            currentSlide,
            nextSlide
            ...
            $(".controler-wrapper .total-controler").text(
        ...
        $(".fashion-shop-slider").on("beforeChange", function(
            event,
            slick,
            currentSlide,
            nextSlide
        ...
        singlepricing.mouseleave(function() {
