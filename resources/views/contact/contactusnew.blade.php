                ...
                <div class="row vert-margin-double justify-content-center">
                    <div class="col-sm-6 col-lg-4">
                        ...
                        <div class="contact-info">
                            ...
                            <div class="contact-info-text">(+974) 3350 0006</div>
                        </div>
                        <div class="contact-info">
                        ...
                        <div class="contact-info">
                            ...
                            <div class="contact-info-text"><a href="mailto:INFO@MARCHECINQ.COM"></a>INFO@MARCHECINQ.COM</div>
                        </div>
                        <div class="contact-info">
                            <div class="contact-info-icon"><i class="icon-location"></i></div>
                            <div class="contact-info-title">ADDRESS:</div>
                            <div class="contact-info-text">DOHA - QATAR</div>
                        </div>
                    </div>
