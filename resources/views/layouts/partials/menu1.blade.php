    ...
    <header class="hdr global_width hdr_sticky hdr-mobile-style2">
                ...
                <div class="mobilemenu-scroll">
                    ...
                    <div class="nav-wrapper show-menu">
                        ...
                        <ul class="nav nav-level-1">
                            <li><a href="/">{{ trans('translations.home')}}</a><span class="arrow"></span>
                            </li>
                            <li><a href="#" title="">{{trans("translations.product")}}</a><span class="arrow"></span>
                            </li>
                            <li><a href="#" title="">{{ trans('translations.store')}}</a><span class="arrow"></span>
                            </li>
                        </ul>
                    </div>
        ...
        <div class="hdr-desktop hide-mobile">
                            ...
                            <div class="dropdn dropdn_language">
                                <div class="dropdn dropdn_caret"><a href="#" class="dropdn-link">ENG</a>
                                    <div class="dropdn-content">
                                        <div class="container">
                                            <ul>
                                               <li class="active"><a href="{{route("setlang",'en')}}""><img src="images1/flags/en.png" alt="">English</a></li>
                                                <li><a href="{{route("setlang",'ar')}}""><img src="images1/flags/sp.png" alt="">Arabic</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="dropdn dropdn_account @@classes"><a href="#" class="dropdn-link"><i class="icon icon-person"></i><span>My Account</span></a>
                                <div class="dropdn-content">
                                    <div class="container">
                                        ...
                                        <ul>
                                            <li><a href="account_details"><i class="icon icon-person-fill"></i><span>My Account</span></a></li>
                                            <li><a href="login"><i class="icon icon-lock"></i><span>{{ trans('translations.login')}}</span></a></li>
                                            <li><a href="signup"><i class="icon icon-person-fill-add"></i><span>{{ trans('translations.signup')}}</span></a></li>
            ...
            <div class="hdr-content hide-mobile">
                <div class="container">
                    <div class="row">
                        <div class="col-auto logo-holder"><a href="index.html" class="logo"><img src="{{asset('img/logo.png')}}" srcset="{{asset('img/logo.png')}}" alt=""></a></div>
                        <!--navigation-->
                        ...
                        <div class="nav-holder">
                            <div class="hdr-nav">
                                ...
                                <ul class="mmenu mmenu-js">
                                    <li class="mmenu-item--simple"><a href="#" title="">{{ trans('translations.home')}}</a>
                                    </li>
